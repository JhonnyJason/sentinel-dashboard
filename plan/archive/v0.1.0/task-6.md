...
- [x] Per-sequence backtesting (backtestSequence → deltaF, maxRiseF, maxDropF, warn)
- [x] Aggregate results across years (avg/median of deltaF, extremes of maxRise/maxDrop)
- [x] Direction detection (avg deltaF > 1 → Long, else Short)
